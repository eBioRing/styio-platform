...
CONTRACT_PATH = ROOT / "contracts/styio-cloud-control-plane/v1/styio-cloud-control-plane.contract.json"
EXAMPLES_PATH = ROOT / "contracts/styio-cloud-control-plane/v1/styio-cloud-control-plane.examples.json"
...
def check_unit(contract: dict[str, Any], examples: dict[str, Any]) -> None:
    ...
    assert contract.get("base_path") == "/api/styio-cloud/v1", "base_path drift detected"
    assert contract.get("internal_base_path") == "/internal/styio-cloud/v1", "internal_base_path drift detected"
...
def main() -> int:
    ...
    try:
        ...
        print(f"[styio-cloud-control-plane-contract-gate] {exc}", file=sys.stderr)
        return 1
    print(f"[styio-cloud-control-plane-contract-gate] mode={args.mode} ok")
    return 0
