# Styio Cloud Control Plane V1 Contract

**Purpose:** Define the native JSON contract package for the first runnable `styio-cloud` cloud service kernel.
...
- `styio-cloud-control-plane.contract.json`
- `styio-cloud-control-plane.examples.json`

Generated or third-party API description formats are not authoritative for
`styio-cloud`. Gates validate these JSON contracts directly.
...
surface implemented by the C++ `styio-cloudd` kernel.
