# Styio Cloud Control-Plane Contract
...
- [`./Styio-Cloud-Hosted-Control-Plane-Contract.md`](./Styio-Cloud-Hosted-Control-Plane-Contract.md)
...
- [`../../contracts/styio-cloud-control-plane/v1/styio-cloud-control-plane.contract.json`](../../contracts/styio-cloud-control-plane/v1/styio-cloud-control-plane.contract.json)
- [`../../contracts/styio-cloud-control-plane/v1/styio-cloud-control-plane.examples.json`](../../contracts/styio-cloud-control-plane/v1/styio-cloud-control-plane.examples.json)
...
The native JSON styio-cloud-control-plane package owns the executable route shape
...
- compile-cloud stress validation must use the public framework described in [Styio Cloud Compile Stress Framework](./Styio-Cloud-Compile-Stress-Framework.md), not a page-local or service-local ad hoc benchmark.
...
- `job_request.api_path = "/api/styio-cloud/v1/jobs"`
- `job_request.action`
