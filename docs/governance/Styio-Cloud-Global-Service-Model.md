...
**Purpose:** Define `styio-cloud` as the global cloud-computing and package-distribution foundation that serves `pafio` clients and hosted products.

**Last updated:** 2026-04-24

## Mission

`styio-cloud` provides the globally scalable service layer for Styio:
...
- native JSON styio-cloud-control-plane contracts, examples, and gates
...
`contracts/styio-cloud-control-plane/v1/`; generated third-party API descriptions
...
paths without connecting to `styio-cloud`.
